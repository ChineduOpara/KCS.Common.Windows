...
namespace KCS.Common.Controls
{
	...
	public class ValuesTracker : Component
    {
		...
		///// <summary> 
		///// Gets an Integer value. If the key does not exists, returns the default.
		///// </summary>
		...
		///// <summary> 
		///// Gets an Int64 value. If the key does not exists, returns the default.
		///// </summary>
		///// <param name="key">Key of value to retrieve.</param>
		///// <param name="default">Default value.</param>
		///// <returns>Int64 value.</returns>
		//public long GetValue(string key, long @default)
		//{
		//    if (Dictionary.ContainsKey(key))
		//    {
		...
		///// <summary> 
		///// Gets a Decimal value. If the key does not exists, returns the default.
		///// </summary>
		///// <param name="key">Key of value to retrieve.</param>
		///// <param name="default">Default value.</param>
		///// <returns>Decimal value.</returns>
		//public decimal GetValue(string key, decimal @default)
		//{
		//    if (Dictionary.ContainsKey(key))
		//    {
		...
		///// <summary> 
		///// Gets a string value. If the key does not exists, returns the default.
		///// </summary>
		///// <param name="key">Key of value to retrieve.</param>
		///// <param name="default">Default value.</param>
		...
		///// <summary> 
		///// Gets a boolean value. If the value does not exists, returns the default.
		///// </summary>
		///// <param name="key">Key of value to retrieve.</param>
		///// <param name="default">Default value.</param>
		///// <returns>String value.</returns>
